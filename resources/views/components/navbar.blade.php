<nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="https://talentcompass.id/login" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-accent-500 to-primary-500 text-sm font-semibold hover:shadow-lg hover:shadow-accent-500/25 hover:-translate-y-0.5 transition-all duration-300">
                    Mulai Sekarang
    ...
    <div id="mobile-menu" class="md:hidden hidden glass-stronger">
        <div class="px-4 py-6 space-y-4">
            ...
            <a href="https://talentcompass.id/login" class="block w-full text-center px-5 py-3 rounded-full bg-gradient-to-r from-accent-500 to-primary-500 font-semibold">Mulai Sekarang</a>
        </div>
    </div>
</nav>
